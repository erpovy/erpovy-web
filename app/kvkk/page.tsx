...
export const metadata: Metadata = {
    ...
    description: "6698 sayılı KVKK uyarınca Erpovy kişisel verilerin işlenmesi, saklanması, güvenliği ve veri sahiplerinin kanuni haklarına ilişkin resmi aydınlatma metni.",
    alternates: {
        canonical: "https://www.erpovy.com/kvkk",
    },
};
export default function Page() {
    return (<InnerPage label="KVKK aydınlatma metni" title="KVKK aydınlatma metni" accent="Bilginiz dahilinde." description="Kişisel verilerinizin işlenmesi ve haklarınıza ilişkin bilgilendirme." closing={false}><section className={s.content}><div className={s.container}><nav className={s.legalNav} aria-label="Yasal belgeler"><Link href="/gizlilik-politikasi/">Gizlilik politikası</Link><Link href="/kullanim-kosullari/">Kullanım koşulları</Link><Link href="/kvkk/">KVKK aydınlatma metni</Link></nav>
