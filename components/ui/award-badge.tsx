...
interface AwardBadgeProps {
  ...
  titleText?: string;
  className?: string;
  theme?: "gold" | "silver" | "bronze" | "brand-dark" | "brand-blue";
...
const title: Record<string, string> = {
  ...
  "erpovy-demo": "İşime uygun demoyu gör",
};
...
export const AwardBadge = ({
  ...
  const onMouseLeave = () => {
    const oppositeMatrix = getOppositeMatrix(matrix, 0);
  ...
  // Determine fill & text color based on theme
  let bgFill = backgroundColor[(place || 2) - 1] || backgroundColor[1];
  let strokeColor = "#bbb";
  let textLabelColor = "#666";
  let titleColor = "#333";

  if (theme === "brand-dark" || type === "erpovy-demo") {
    bgFill = "#070d1c";
    strokeColor = "rgba(25, 146, 209, 0.5)";
    textLabelColor = "#1992d1";
    titleColor = "#ffffff";
  } else if (theme === "brand-blue") {
    bgFill = "#1992d1";
    strokeColor = "rgba(255, 255, 255, 0.4)";
    textLabelColor = "#e0f2fe";
    titleColor = "#ffffff";
  }

  const displayBadgeLabel = badgeLabel ?? (type === "erpovy-demo" ? "ERPOVY · CANLI DEMO" : "PRODUCT HUNT");
  const displayTitle = titleText ?? (title[type] ? `${title[type]}${place ? ` #${place}` : ""}` : "İşime uygun demoyu gör");
  ...
  return (
    <a
      ...
      onClick={onClick}
      className={`block w-[240px] sm:w-[280px] h-auto cursor-pointer select-none ${className || ""}`}
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 58" className="w-[240px] sm:w-[280px] h-auto drop-shadow-md">
          <defs>
            <filter id="blur1">
              <feGaussianBlur in="SourceGraphic" stdDeviation="3" />
            </filter>
            <mask id="badgeMask">
              <rect width="280" height="58" fill="white" rx="12" />
            </mask>
          </defs>
          <rect width="280" height="58" rx="12" fill={bgFill} />
          <rect x="3" y="3" width="274" height="52" rx="10" fill="transparent" stroke={strokeColor} strokeWidth="1.2" />

          {/* Icon or Crest */}
          <g transform="translate(10, 11)">
            {type === "erpovy-demo" ? (
              // Glowing Arrow / Play Icon for Demo
              <g transform="translate(4, 4)">
                <circle cx="14" cy="14" r="14" fill="#1992d1" fillOpacity="0.25" />
                <path d="M11 9l9 5-9 5V9z" fill="#1992d1" />
              </g>
            ) : (
              // Product Hunt Laurel Wreath
              <path fill={textLabelColor}
          ...
          <text fontFamily="system-ui, -apple-system, sans-serif" fontSize="10" fontWeight="bold" letterSpacing="0.8" fill={textLabelColor} x="54" y="21">
            {displayBadgeLabel}
          </text>
          <text fontFamily="system-ui, -apple-system, sans-serif" fontSize="15" fontWeight="bold" fill={titleColor} x="53" y="42">
            {displayTitle}
          </text>
          ...
          <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)">
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(358, 100%, 62%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(30, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(60, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(96, 100%, 50%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(200, 85%, 55%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(220, 85%, 55%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="hsl(271, 85%, 47%)" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="transparent" filter="url(#blur1)" opacity="0.5" />
            </g>
            <g style={{
            ...
            <g style={{
              ...
              <polygon points="0,0 280,58 280,0 0,58" fill="white" filter="url(#blur1)" opacity="0.5" />
            </g>
          </g>
        </svg>
      </div>
